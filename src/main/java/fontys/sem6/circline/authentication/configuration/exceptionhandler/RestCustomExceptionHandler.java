package fontys.sem6.circline.authentication.configuration.exceptionhandler;
...
public class RestCustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException error, final HttpHeaders headers, final HttpStatusCode status, final WebRequest request) {
